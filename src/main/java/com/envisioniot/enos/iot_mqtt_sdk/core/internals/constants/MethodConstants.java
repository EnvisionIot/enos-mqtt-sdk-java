...
public class MethodConstants {
    ...
    public static final String THING_EVENT = "thing.model.event";
    ...
    public static final String MEASUREPOINT_POST = "thing.event.measurepoint.post";
    ...
    public static final String SUB_DEVICE_REGISTER = "thing.sub.register";
    public static final String TAG_DELETE = "thing.deviceinfo.delete";
    public static final String TAG_UPDATE = "thing.deviceinfo.update";
